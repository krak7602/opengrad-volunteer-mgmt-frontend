            ...
            <div className="pb-2 pt-1">
                ...
                <div className="flex items-end gap-2">
                    <div className="grid gap-1 text-center">
                        ...
                        <Select onValueChange={(value) => { handleTimeChange(value, index, "hour", "start") }}>
                    ...
                    <div className="grid gap-1 text-center">
                        ...
                        <Select onValueChange={(value) => { handleTimeChange(value, index, "min", "start") }}>
                            <SelectTrigger className="w-[62px] text-center font-mono text-base tabular-nums caret-transparent focus:bg-accent focus:text-accent-foreground [&::-webkit-inner-spin-button]:appearance-nonew-[25px]" >
                                <SelectValue placeholder="--" />
                            </SelectTrigger>
                            <SelectContent>
            ...
            <div className="pt-1">
                ...
                <div className="flex items-end gap-2">
                    <div className="grid gap-1 text-center">
                        ...
                        <Select onValueChange={(value) => { handleTimeChange(value, index, "hour","end") }}>
                            <SelectTrigger className="w-[62px] text-center font-mono text-base tabular-nums caret-transparent focus:bg-accent focus:text-accent-foreground [&::-webkit-inner-spin-button]:appearance-nonew-[25px]" >
                                <SelectValue placeholder="--" />
                            </SelectTrigger>
                            <SelectContent>
                    ...
                    <div className="grid gap-1 text-center">
                        ...
                        <Select onValueChange={(value) => { handleTimeChange(value, index, "min", "end") }}>
                            <SelectTrigger className="w-[62px] text-center font-mono text-base tabular-nums caret-transparent focus:bg-accent focus:text-accent-foreground [&::-webkit-inner-spin-button]:appearance-nonew-[25px]" >
                                <SelectValue placeholder="--" />
                            </SelectTrigger>
                            <SelectContent>
