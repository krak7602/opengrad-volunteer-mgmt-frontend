        ...
        if (emailSent) {
            return (
                <div>
                    ...
                    <div className="px-4 text-center text-neutral-600">An email will be sent to your account with the password reset instructions if an valid profile exists.</div>
                </div>
            )
        }
        return (
            <div>
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                        <FormDescription className="pl-3">Provide your email to send instructions to reset the password</FormDescription>
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="px-3">
                                    ...
                                    <FormControl>
                                        <Input type="email" placeholder="" {...field} onChange={e => { setEmail(e.target.value) }} />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
                        />
                        <Button type="submit" className="ml-3">Sent reset email</Button>
                    </form>
                </Form>
        ...
        <Drawer open={open} onOpenChange={setOpen}>
            ...
            <DrawerContent className="pb-6">
                <DrawerHeader className="text-left">
                    <DrawerTitle className="text-2xl font-bold px-1">Reset your password</DrawerTitle>
                </DrawerHeader>
                <div className="px-2">
                    <PasswordResetForm />
                </div>
...
const MailAccountIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={60} height={60} color={"#22c55e"} fill={"none"} {...props}>
