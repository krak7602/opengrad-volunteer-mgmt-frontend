            ...
            <Tabs defaultValue="new">
                ...
                <TabsContent value="search">
                    <div className="overflow-x-auto px-1 pt-2">
                                    ...
                                    <PopoverTrigger asChild>
                                        <Button
                                            ...
                                            <div className="mx-2">
                                                ...
                                                {recipientPartnerCount != 0 && <div>
                                                    {recipientPartners[0]?.user_id?.name}
                                                </div>}
                                                {recipientCohortCount == 0 && recipientPartnerCount == 0 && <div>
                                                    Select recipient
                                                </div>}
                                            </div>
                                        </Button>
                        ...
                        {notifDataPoc.data && notifDataPoc.data.constructor === Array && <div>
