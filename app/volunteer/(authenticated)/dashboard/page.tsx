            ...
            <div className="container mx-auto my-6 px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col gap-3 items-start justify-between mb-2 pb-4">
                    <div className="flex flex-col gap-1">
                        <h1 className="rounded-sm text-xs bg-primary text-white p-1 font-bold pl-1 md:mr-5 w-min">{PocDetails?.data?.user_id?.name}</h1>
                    ...
                    <Select onValueChange={(val) => setCohort(val)}>
                        ...
                        <SelectContent>
                            {data?.Cohorts && data.Cohorts.constructor === Array && <div>
